...
int main(){
   ...
   /* strings = deleteEntry(strings, size, "Lili");
    cout<<"\nAfter strings = deleteEntry(strings, size, \"Lili\");\n";
    displaysarray(strings , size);
    cout<<endl ;
    ...
    displaysarray(strings, size);
    cout<<endl ;
  /*  strings = addEntry(strings, size, "Lili");
    cout<<"\nAfter strings = addEntry(strings, size, \"Lili\");\n";
    displaysarray(strings, size);
    cout<< endl ; */
